          ...
          <div className={styles.formPanel}>
            <form className={styles.contactForm}>
              ...
              <label className={styles.fullWidth}>
                ...
                <textarea name="details" rows={5} placeholder="Share your venue, moodboard, attire, and any must-have looks." />
              </label>
              <div className={styles.formFooter}>
                <label className={styles.checkbox}>
                  <input type="checkbox" name="newsletter" />
                  <span>Keep me updated on masterclasses and exclusive drops.</span>
                </label>
                <button type="submit" className={styles.submitButton}>Request consultation</button>
              </div>
